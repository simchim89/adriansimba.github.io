...
#### [Botium Toys — Controls & Compliance Checklist](./Controls%20and%20compliance%20checklist%20Boitum%20Toys.pdf)
Companion document evaluating security controls and compliance gaps across the organisation. Maps findings to industry frameworks.
...
Hands-on network simulations using Cisco Packet Tracer. Labs will be uploaded here as they are completed, each with a short write-up explaining the scenario and what was learned.
